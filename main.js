...
// A:
//string it's going to say, "hello, how are you Tim"
...
// A:
let youName = ('Yana') //no r
console.log('Yana')
let instructorsName = ('Jason') // addes s
console.log('Jason')

// This statement should read correctly
let statement = youName + " is taking a class at The Iron Yard, my instructor's name is " + instructorsName;
